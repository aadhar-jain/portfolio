...
const Contacts = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_7pcxkek', 'template_hfl46wc', formRef.current, {
            publicKey: 'vtvQiu2tsi91Vd_nJ',
        })
            .then((result) => {
                setSuccess(true);
            },
    ...
    return (
        <motion.div ref={ref} className='contacts' variants={variants} initial="initial" whileInView="animate">
            ...
            <motion.div className="textContainer" variants={variants}>
                ...
                Let's <motion.span className="work">work</motion.span> together
                </motion.h1>
                <motion.div className="item" variants={variants}>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Address</h2>
                    <span><a href="https://www.google.co.in/maps/place/Saharanpur,+Uttar+Pradesh/@29.963627,77.5152273,13z/data=!3m1!4b1!4m6!3m5!1s0x390eea921f841f45:0x39baf780903811f!8m2!3d29.9680035!4d77.5552066!16zL20vMDVoN3hq?entry=ttu">Saharanpur, UttarPradesh- 247001</a></span>

                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>LinkedIn</h2>
                    <span><a href="https://www.linkedin.com/in/aadhar-j/">Aadhar_Jain</a></span>
                </motion.div>
            </motion.div>
            ...
            <div className="formContainer">
                <motion.div className="phoneSvg"
                    ...
                    <svg fill="#000000" width="350px" height="350px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
